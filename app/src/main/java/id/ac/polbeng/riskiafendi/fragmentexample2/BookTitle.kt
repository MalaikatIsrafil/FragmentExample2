package id.ac.polbeng.riskiafendi.fragmentexample2
...
import id.ac.polbeng.riskiafendi.fragmentexample2.databinding.BookTitlesBinding
...
class BookTitle : Fragment(), View.OnClickListener {
    ...
    override fun onClick(v: View) {
        ...
        if (activity is Coordinator){  //terikat dengan interface coordinator
